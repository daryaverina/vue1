...
export default{
    data(){
        return {
            posts: [
                {id:1, title:'кошки', body:'кошки крутые'},
                {id:2, title:'собаки', body:'собаки крутые'},
                {id:3, title:'мыши', body:'мыши крутые'},
                {id:4, title:'попугаи', body:'попугаи крутые'},
            ],
            title: '',
            body: ''
        }
